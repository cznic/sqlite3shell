...
func XFlushViewOfFile(tls *TLS, lpBaseAddress uintptr, dwNumberOfBytesToFlush uint32) int32 {
...
func XHeapAlloc(tls *TLS, hHeap uintptr, dwFlags uint32, dwBytes uint32) uintptr {
...
func XHeapCompact(tls *TLS, hHeap uintptr, dwFlags uint32) uint32 {
...
func XHeapCreate(tls *TLS, flOptions uint32, dwInitialSize uint32, dwMaximumSize uint32) uintptr {
...
func XHeapReAlloc(tls *TLS, hHeap uintptr, dwFlags uint32, lpMem uintptr, dwBytes uint32) uintptr {
...
func XHeapSize(tls *TLS, hHeap uintptr, dwFlags uint32, lpMem uintptr) uint32 {
...
func XMapViewOfFile(tls *TLS, hFileMappingObject uintptr, dwDesiredAccess uint32, dwFileOffsetHigh uint32, dwFileOffsetLow uint32, dwNumberOfBytesToMap uint32) uintptr {
